...
if (isset($_POST['submit'])) {
  ...
  if (empty($nameError) && empty($discordError) && empty($bodyError)) {
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="mt-4 w-75">
  <div class="mb-3">
    <label for="name" class="form-label">Nickname (Optionally include Discord Server)</label>
  ...
  <div class="mb-3">
    ...
    <textarea maxlength="255" class="form-control  <?php echo !$bodyError ?: 'is-invalid'; ?>" id="body" name="body" placeholder="Enter your suggestion(s) Limited to 255 characters"></textarea><br>
    <div id="counter"></div>
    <div class="invalid-feedback">
      <?php echo $bodyError ?>
    </div>
